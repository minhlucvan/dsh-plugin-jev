...
const en = {
  ...
  credentialHint:
    'The value behind the variable named above. It is stored outside the settings file and is never shown again.',
...
const zh: Record<MessageKey, string> = {
  ...
  credentialHint: '上面变量名对应的密钥值。它保存在设置文件之外，之后不会再显示。',
