...
const en = {
  ...
  adoptionPromptLabel: 'Adoption guidance',
  adoptionPromptHint:
    'When on, the system prompt tells the agent to prefer Jev for the decisions it covers.',
  banksLabel: 'Question banks',
  banksHint:
    'The banks the agent may classify with. Every bank checked means every bank this build ships.',
  banksUnavailable: 'Could not read the question banks.',
  ...
  credentialHint:
    'The TypeSafe key. It is stored outside the settings file and is never shown again.',
  credentialLoading: 'Reading the key…',
  ...
  credentialFailed: 'Could not update the key',
  modelLabel: 'Model',
...
const zh: Record<MessageKey, string> = {
  ...
  adoptionPromptLabel: '采用引导',
  adoptionPromptHint: '开启后，系统提示会告知智能体在这些决策上优先使用 Jev。',
  banksLabel: '问题库',
  banksHint: '智能体可用于分类的问题库。全部勾选即表示包含此构建的全部问题库。',
  banksUnavailable: '无法读取问题库。',
  apiKeyEnvLabel: 'API 密钥变量',
  apiKeyEnvHint: '保存 TypeSafe 密钥的环境变量名。密钥本身不会保存在这里。',
  credentialLabel: 'API 密钥',
  credentialHint: 'TypeSafe 密钥。它保存在设置文件之外，之后不会再显示。',
  credentialLoading: '正在读取密钥…',
